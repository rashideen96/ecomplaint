...
if(isset($_POST['submit']))
{
	...
	{
		$sql = "INSERT INTO complaint(studID, studName, studEmail, studPhoneNo, dept, location, roomNo, complaintType, complaintDesc, complaintPrior, availableTime, img) VALUES('$ID', '$name', '$email', '$phone_no', '$dept', '$location', '$roomNo', '$complaintType', '$complaintDesc', '$complaintPrior', '$availableTime', '$file_name')";
		$result = mysqli_query($conn, $sql);
		if(!$result)
		{
		...
		<div class="col-lg-6 col-md-6">
			<form action="" method="post" enctype="multipart/form-data">
				<div class="form-group">
					<label>ID</label>
					<input class="form-control r" type="number" name="ID" placeholder="ID" id="ID" maxlength="11" autocomplete="off">
					<span id="student_check" style="font-size: 12px;"></span>
				</div>
				<div class="form-group">
					<label>Name</label>
					<input class="form-control r" type="text" name="name" placeholder="Name" id="name" autocomplete="off" required>
				</div>
				<div class="form-group">
					<label>Email</label>
					<input class="form-control r" type="email" name="email" placeholder="example@domain.com" required>
				</div>
				<div class="form-group">
					<label>Phone/Mobile</label>
					<input class="form-control r" type="text" name="phone_no" placeholder="Eg. 0133634357" maxlength="10" required>
				</div>
				<!-- <div class="form-group">
